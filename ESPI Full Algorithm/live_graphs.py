...
----------
    ...
    live_graph = live_graphs.create_live_graph("histogram")  # or "3d", or None
    ...
...
def create_live_graph(graph_type: str | None):
    ...
    Args:
        graph_type : "histogram", "3d", or None/"" to disable the live
                     graph entirely (the common case — the graph window
                     costs extra render time, so it is opt-in).

    Returns:
        A LiveHistogram, a LiveSurfacePlot, or None.
